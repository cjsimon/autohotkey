...
return
HotCorners: 			 ; HotCorners Timer
CoordMode, Mouse, Screen ; Coordinates will be passed to mouse related functions,
						 ; with coords relative to entire screen 
 
IsCorner(cornerID)
{
	WinGetPos, X, Y, Xmax, Ymax, Program Manager 					; Get the desktop size
	MouseGetPos, MouseX, MouseY 									; MouseGetPos retrieves the current position of the mouse cursor
