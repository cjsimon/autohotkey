...
; SendMode: Recommended for new scripts due to its superior speed and reliability
; SetWorkingDir: Ensures a consistent starting directory
; SingleInstance: Ensures that only the last executed instance of script is running
#NoEnv
#NoTrayIcon
